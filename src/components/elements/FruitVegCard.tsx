              ...
              <div className="flex flex-wrap">
                ...
                <div className="w-6/12">
                  <div className="mt-12 relative flex flex-col items-center">
                    <img className="image-shadow relative w-auto h-auto max-h-[87%] max-w-[96%] mt-[-26px]" src={circle} alt="Circle" style={{ filter: "drop-shadow(5px 11px 15px #222)" }} />
                    ...
                    {String(item.price).toLowerCase().includes("for") && (
                      <div className="absolute text-black">
                        <div className="text-[80px] font-bold text-center " style={{ marginBottom: "-35px" }}>
                          {item.price.split(" ")[0]}
                        </div>
