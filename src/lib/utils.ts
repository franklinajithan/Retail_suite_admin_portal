...
export const productFormSchema = z.object({
  ...
  reorderLevelType: z.string().optional(),
  ...
  item_details: z.object({
    ...
    isPluCoded: z.boolean().optional(),
    isSeasoned: z.boolean().optional(),
    isStoreUse: z.boolean().optional(),
    isWeighted: z.boolean().optional(),
    hasLeadTime: z.boolean().optional(),
    canBeInPromo: z.boolean().optional(),
    canSplitSell: z.boolean().optional(),
    canStockTake: z.boolean().optional(),
    isOutOfStock: z.boolean().optional(),
    needPreOrder: z.boolean().optional(),
    splitSellQty: z.number().nullable().optional(),
    hasBoxBarcode: z.boolean().optional(),
    hasLinkedItem: z.boolean().optional(),
    isPriceMarked: z.boolean().optional(),
    minSellingQty: z.number().nullable().optional(),
    isDiscontinued: z.boolean().optional(),
    isDiscountable: z.boolean().optional(),
    isStoreVisible: z.boolean().optional(),
    hasOuterBarcode: z.boolean().optional(),
    isAgeRestricted: z.boolean().optional(),
    canOrderInPallet: z.boolean().optional(),
    hasMinSellingQty: z.boolean().optional(),
    hasPalletBarcode: z.boolean().optional(),
    canPurchaseLocally: z.boolean().optional(),
    isStoreTransferable: z.boolean().optional(),
    isConsideredForPurchasePlan: z.boolean().optional(),
  }).optional(),
});
